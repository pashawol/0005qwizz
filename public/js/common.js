...
function eventHandler() {
	...
	JSCCommon.modalCall();
	JSCCommon.inputMask();
	JSCCommon.datepicker(); // JSCCommon.CustomInputFile();
	// добавляет подложку для pixel perfect

	$(".main-wrapper").after('<div class="screen" style="background-image: url(screen/QUIZ_1.jpg);"></div>'); // /добавляет подложку для pixel perfect
}
